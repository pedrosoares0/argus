...
- **Ícone de identidade**: um ícone de mascote arredondado (formato "blob" orgânico, sem cantos duros) em tom de azul, com dois pontos simulando olhos — usar como avatar/ícone de app enquanto a identidade visual definitiva não é fechada (Peu está cuidando disso separadamente).
