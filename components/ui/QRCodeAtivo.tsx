          ...
          <div className="bg-white rounded-[28px] p-6 max-w-sm w-full shadow-2xl border border-gray-100/80 space-y-5 animate-[scaleIn_0.2s_ease-out]">
            ...
            <div className="bg-amber-50/50 border border-amber-200/50 rounded-xl p-3 flex gap-2">
              ...
              <p className="text-[10px] text-amber-800 font-medium leading-relaxed">
                Se a câmera do celular estiver quebrada ou sem permissão, o inspetor pode digitar o código manual acima no app para abrir o checklist deste ativo.
              </p>
            </div>
