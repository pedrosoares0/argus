...
const configPill: Record<CorPill, { bg: string; iconBg: string; icon: React.ReactNode }> = {
  ...
  cinza: {
    bg: 'bg-gradient-to-b from-[#64748B] to-[#475569] text-white shadow-[0_3px_10px_rgba(71,85,105,0.25)]',
    iconBg: 'w-5 h-5 flex items-center justify-center',
    icon: (
      <span className="inline-flex items-center gap-0.5 px-0.5">
        <span className="w-1 h-1 rounded-full bg-white/90 animate-bounce [animation-delay:-0.3s]" />
        <span className="w-1 h-1 rounded-full bg-white/90 animate-bounce [animation-delay:-0.15s]" />
